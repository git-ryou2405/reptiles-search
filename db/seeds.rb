...
User.create!(
  ...
  prefectures: "東京都", address: "東京都中野区中野６丁目１５−１３", howto_access: "xx駅から徒歩y分 ⬇︎", tel: "03-xxxx-xxxx", business_hours: "xx時〜yy時", holiday: "○曜日", url: "http://www.hachikura.com/",
...
User.create!(
  ...
  prefectures: "茨城県", address: "茨城県日立市中成沢町3-14-7", howto_access: "xx駅から徒歩y分 ⬇︎", tel: "02-xxxx-xxxx", business_hours: "xx時〜yy時", holiday: "○曜日", url: "https://www.w-monster.com/",
  handling_animals: "ヘビ、トカゲ、ヤモリ、カメ、両生類、奇虫・昆虫", handling_feeds: "活エサ・冷凍エサ・人工飼料・栄養剤・補助品・その他のエサ",
  handling_goods: "飼育セット/飼育ケージ/照明器具/保温器具/床材/レイアウト用品/水入れ・餌入れ/ナミバテラ社製品/本・ＤＶＤ/その他の飼育用品",
