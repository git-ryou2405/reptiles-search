...
# herokuにアップすると蓄積されていまうため一旦全削除する
...
User.create!(
  ...
  holiday: "○曜日",
  url: "http://www.hachikura.com/",
  handling_animals: "ヘビ、トカゲ、ヤモリ、カメ、両生類、奇虫・昆虫",
  ...
  # File.open("#{Rails.root}/public/uploads/TestFolder/user2.jpg")
